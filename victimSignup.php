...
<body>
    ...
    <div class="login">
        ...
        <h2 class="login-header">Victim SignUp</h2>
        ...
        <form class="login-container" method="POST" action="registration.php">
          ...
          <p style="text-align: center;"><strong>Already have an account? <a href="victimLogin.php"><span style="color:brown"> Login </span></a><strong></p>
        </form>
