...
<body>
    ...
    <div class="login">
        ...
        <form class="login-container" method="POST" action="registration.php">
          ...
          <p style="text-align: center;"><strong>Already have an account? <a href="adminLogin.php"><span style="color:brown"> Login </span></a><strong></p>
        </form>
