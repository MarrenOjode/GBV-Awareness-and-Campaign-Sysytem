...
<body>
    ...
    <div class="login">
        ...
        <h2 class="login-header">Volunteer Login</h2>
        ...
        <form class="login-container"  method="POST" action="login2.php">
          ...
          <p><a href="reset.html" id="forgot">Forgot Password?</a></p>
          <p><input type="submit" value="Log in"></p>
          <p style="text-align: center;"><strong>Need an account? <a href="volunteerSignup.php"><span style="color:brown;"> Sign Up </span></a><strong></p>
        </form>
